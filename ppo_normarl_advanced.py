...
if __name__ == "__main__":
    ...
    for update in range(1, num_updates + 1):
        ...
        with torch.no_grad():
            ...
            if update == 1:
                obs = next_obs  # Use observations from initial reset
            else:
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, len(b_obs_positions), args.minibatch_size):
        ...
        print(f"KL divergence: {approx_kl.item():.4f}")
