...
class LimitedResourcesEnv(gym.Env):
    ...
    def _render_frame(self):
        ...
        for resource_id, resource in self.resources_info.items():
            ...
            if resource["available"]:
								# Desenhar o recurso apenas se estiver disponível
                pygame.draw.rect(
									canvas,
									resource_color,
									pygame.Rect(
...
if __name__ == '__main__':
    ...
    env = LimitedResourcesEnv(render_mode="human", config_path=config_path, drive_type=drive_type, size=10)
    env.reset()
