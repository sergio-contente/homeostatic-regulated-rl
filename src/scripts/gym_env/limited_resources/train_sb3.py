...
drive_type = "base_drive"  # ou "elliptic_drive", "interoceptive_drive"

current_time = datetime.now().strftime('%Y%m%d-%H%M%S')
log_dir = os.path.join('runs', f'SB3_DQN_LimitedResources_{drive_type}_{current_time}')
...
# === ENVIRONMENT SETUP ===
raw_env = gym.make("LimitedResources-v0", config_path=config_path, drive_type=drive_type)
