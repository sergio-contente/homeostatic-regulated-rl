...
def test_scenario_comparison():
    ...
    for scenario in scenarios:
        ...
        print(f"🌱 Regeneration rate: {base_env.resource_manager.get_resource_stock_regeneration_array()}")
...
def compare_scenarios(results):
    ...
    if single["system_collapsed"] and all_consumers["system_collapsed"]:
        print(f"   Both systems collapsed - regeneration insufficient")
        ...
        print(f"   🤔 Unexpected: single consumer collapsed but all survived")
    else:
        print(f"   🌱 Both systems sustainable - high regeneration rate")
...
if __name__ == "__main__":
    ...
    print(f"\n✅ Test completed!")
    print(f"💡 This demonstrates the Tragedy of Commons in action") 
