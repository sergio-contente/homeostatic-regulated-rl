"""Test regeneration with only agent_0 consuming while others move."""
...
def test_single_consumer():
    ...
    for round_num in range(max_rounds):
        ...
        for step in range(3):
            ...
            before_drive = agent.compute_drive()
            ...
            if agent_id in env.agents:  # Agent might be terminated
                ...
                after_drive = agent.compute_drive()
...
if __name__ == "__main__":
    ...
    print("Replace the _check_resource_regeneration method with Option 1 (regeneration before consumption)")
    print()
