...
|----------------|-------|--------------------------------------------------------------|
| αᵠ             | 0.3   | Learning rate of state-action values                         |
| β              | 0.6   | Inverse temperature of action selections                     |
| γ              | 0.9   | Discount rate                                                |
| m              | 3     | Free parameter of the drive function                         |
| n              | 4     | Free parameter of the drive function                         |
| τ              | 200   | Attenuation rate of the internal state                       |
